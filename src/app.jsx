              ...
              <div className={"articles"}>
                ...
                <div className="articles__items">
                  ...
                  <div className="articles__slider">
                    <Slider items={[
                      <CardArticle instance="swiper-articles" classes={"cardArticle--isSmall"} title="Промежуточные итоги работы с федеральной программой «Профессионалитет»" tags={["CEO", "Мероприятие"]} date={"23.05.23"} image={"./images/article2.png"} link={""}>
                        Чтобы вам было проще разработать акцию, мы собрали семь распространённых идей. Их можно адаптировать для большинства типов бизнеса. Мы покажем примеры акций из digital — от компании, которая продвигает сайты.Чтобы вам было проще разработать акцию, мы собрали  Чтобы вам было проще разработать акцию, мы собрали семь распространённых идей. Их можно адаптировать для большинства типов бизнеса. Мы покажем примеры акций из digital — от компании, которая продвигает сайты.Чтобы вам было проще разработать акцию, мы собрали.
                      </CardArticle>,
                      <CardArticle classes={"cardArticle--isSmall"} title="Промежуточные итоги работы с федеральной программой «Профессионалитет»" tags={["CEO", "Мероприятие"]} date={"23.05.23"} image={"./images/article3.png"} link={""}>
                        Чтобы вам было проще разработать акцию, мы собрали семь распространённых идей. Их можно адаптировать для большинства типов бизнеса. Мы покажем примеры акций из digital — от компании, которая продвигает сайты.Чтобы вам было проще разработать акцию, мы собрали  Чтобы вам было проще разработать акцию, мы собрали семь распространённых идей. Их можно адаптировать для большинства типов бизнеса. Мы покажем примеры акций из digital — от компании, которая продвигает сайты.Чтобы вам было проще разработать акцию, мы собрали.
                      </CardArticle>,
              ...
              <div className={"articles"}>
                ...
                <div className="news__items">
                  <div className="news__slider">
                    <Slider instance="swiper-news" items={ Array.from({ length: 9 }, () => <CardArticle classes={"cardArticle--isSmall"} title="Промежуточные итоги работы с федеральной программой «Профессионалитет»" tags={["CEO", "Мероприятие"]} date={"23.05.23"} link={""}>
                        Чтобы вам было проще разработать акцию, мы собрали семь распространённых идей. Их можно адаптировать для большинства типов бизнеса. Мы покажем примеры акций из digital — от компании, которая продвигает сайты.Чтобы вам было проще разработать акцию, мы собрали  Чтобы вам было проще разработать акцию, мы собрали семь распространённых идей. Их можно адаптировать для большинства типов бизнеса. Мы покажем примеры акций из digital — от компании, которая продвигает сайты.Чтобы вам было проще разработать акцию, мы собрали.
                      </CardArticle>)} />
                  </div>
                </div>
